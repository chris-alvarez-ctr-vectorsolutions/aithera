# Bridge — Prototyping Notes

> **Bridge** is the internal name for the effort to unify EHS (safety) and Convergence (LMS). This product folder was formerly "EHS Prevent"; the prototypes here cover the EHS ↔ Convergence connective layer. The rule below still applies.

## AI / Smart Recommendations rule

When building any AI-powered or "smart" recommendation surface in Bridge prototypes:
...
This rule applies to every AI feature added to Bridge prototypes from this point forward, unless the user explicitly says otherwise.
