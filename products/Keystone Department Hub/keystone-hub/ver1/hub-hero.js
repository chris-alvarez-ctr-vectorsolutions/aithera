...
(function () {
  ...
  function pdPrintDoc(title, meta, widgets, ownerLabel) {
    return '<div class="kx-printdoc">' +
      ...
      '</div>' +
      '<div class="kx-printdoc-foot">Generated by Keystone · data as of ' +
  ...
  function pdExportDashboard(kind) {
    ...
    var meta = cfg.scope + ' · Keystone · ' + KX.fmtDate(new Date());
  ...
  function wire() {
    ...
    root.addEventListener('click', function (e) {
      ...
      if ((openRangeMenu || openDashMenu || openExportMenu || openWidgetMenu) &&
