...
ON-STAGE RULE (scenes): if the learner will later be asked to confront or account for a specific character (a later phase names them as its counterpart), that character MUST act ON-STAGE in THIS scene's beats — named, by a concrete visible action — never left only in reactionGuidance. Establish the antagonist by action before the confrontation, or the learner reaches it never having seen them do anything.
