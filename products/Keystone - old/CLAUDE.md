...
## Quick Reference
- **Component Reference**: See @VECTOR_COMPONENTS_REFERENCE.md for complete list of Vector components with HTML tags, props, and usage examples
...
1. Check `VECTOR_COMPONENTS_REFERENCE.md` for component HTML tags and common props
...
- Set attributes and properties as documented in `VECTOR_COMPONENTS_REFERENCE.md`

**IMPORTANT:**
- **Always refer to `VECTOR_COMPONENTS_REFERENCE.md`** for correct component tag names
...
For the complete list with props and examples, see `VECTOR_COMPONENTS_REFERENCE.md`
